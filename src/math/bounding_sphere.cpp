...
namespace math
{
API BoundingSphere::BoundingSphere()
    : radius(0)
{
}

API BoundingSphere::BoundingSphere(const Vector3& center, float radius)
{
    set(center, radius);
}

API BoundingSphere::BoundingSphere(const BoundingSphere& copy)
{
    set(copy);
}
...
API const BoundingSphere& BoundingSphere::empty()
{
    static BoundingSphere s;
    return s;
}

API bool BoundingSphere::intersects(const BoundingSphere& sphere) const
{
...
API bool BoundingSphere::intersects(const BoundingBox& box) const
{
...
API bool BoundingSphere::intersects(const Frustum& frustum) const
{
...
API float BoundingSphere::intersects(const Plane& plane) const
{
...
API float BoundingSphere::intersects(const Ray& ray) const
{
...
API bool BoundingSphere::isEmpty() const
{
    return radius == 0.0f;
}

API void BoundingSphere::merge(const BoundingSphere& sphere)
{
    if (sphere.isEmpty())
        return;
...
API void BoundingSphere::merge(const BoundingBox& box)
{
    if (box.isEmpty())
        return;
...
API void BoundingSphere::set(const Vector3& center, float radius)
{
    this->center = center;
    this->radius = radius;
}

API void BoundingSphere::set(const BoundingSphere& sphere)
{
    center = sphere.center;
    radius = sphere.radius;
}

API void BoundingSphere::set(const BoundingBox& box)
{
...
API void BoundingSphere::transform(const Matrix& matrix)
{
...
API float BoundingSphere::distance(const BoundingSphere& sphere, const Vector3& point)
{
...
API bool BoundingSphere::contains(const BoundingSphere& sphere, Vector3* points, unsigned int count)
{
