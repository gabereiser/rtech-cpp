...
API BoundingBox::BoundingBox(const Vector3& min, const Vector3& max)
{
    set(min, max);
}

API BoundingBox::BoundingBox(float minX, float minY, float minZ, float maxX, float maxY, float maxZ)
{
    set(minX, minY, minZ, maxX, maxY, maxZ);
}

API BoundingBox::BoundingBox(const BoundingBox& copy)
{
    set(copy);
}
...
API const BoundingBox& BoundingBox::empty()
{
...
API Vector3 BoundingBox::getCenter() const
{
    Vector3 center;
    getCenter(&center);
    return center;
...
API bool BoundingBox::intersects(const BoundingSphere& sphere) const
{
    return sphere.intersects(*this);
}

API bool BoundingBox::intersects(const BoundingBox& box) const
{
...
API bool BoundingBox::intersects(const Frustum& frustum) const
{
...
API float BoundingBox::intersects(const Plane& plane) const
{
...
API float BoundingBox::intersects(const Ray& ray) const
{
...
API bool BoundingBox::isEmpty() const
{
    return min.x == max.x && min.y == max.y && min.z == max.z;
}

API void BoundingBox::merge(const BoundingBox& box)
{
...
API void BoundingBox::merge(const BoundingSphere& sphere)
{
...
API void BoundingBox::set(const Vector3& min, const Vector3& max)
{
    this->min = min;
    this->max = max;
}

API void BoundingBox::set(float minX, float minY, float minZ, float maxX, float maxY, float maxZ)
{
...
API void BoundingBox::set(const BoundingBox& box)
{
    min = box.min;
    max = box.max;
}

API void BoundingBox::set(const BoundingSphere& sphere)
{
    const Vector3& center = sphere.center;
    float radius = sphere.radius;
...
API void BoundingBox::transform(const Matrix& matrix)
{
