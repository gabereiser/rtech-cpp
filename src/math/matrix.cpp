...
API Matrix::Matrix(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
               float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44)
{
    set(m11, m12, m13, m14, m21, m22, m23, m24, m31, m32, m33, m34, m41, m42, m43, m44);
}

API Matrix::Matrix(const float* m)
{
    set(m);
}

API Matrix::Matrix(const Matrix& copy)
{
...
API const Matrix& Matrix::identity()
{
    static Matrix m(
        1, 0, 0, 0,
        0, 1, 0, 0,
...
API void Matrix::createLookAt(const Vector3& eyePosition, const Vector3& targetPosition, const Vector3& up, Matrix* dst)
{
    createLookAt(eyePosition.x, eyePosition.y, eyePosition.z, targetPosition.x, targetPosition.y, targetPosition.z,
                 up.x, up.y, up.z, dst);
}

API void Matrix::createLookAt(float eyePositionX, float eyePositionY, float eyePositionZ,
                                     ...
                                     float zNearPlane, float zFarPlane, Matrix* dst)
{
    ...
    {
        _ERROR("Invalid field of view value (%d) causes attempted calculation tan(%d), which is undefined.", fieldOfView, theta);
        return;
    }
...
API void Matrix::createOrthographic(float width, float height, float zNearPlane, float zFarPlane, Matrix* dst)
{
...
API void Matrix::createBillboard(const Vector3& objectPosition, const Vector3& cameraPosition,
...
API void Matrix::createBillboardHelper(const Vector3& objectPosition, const Vector3& cameraPosition,
                                   const Vector3& cameraUpVector, const Vector3* cameraForwardVector,
                                   Matrix* dst)
{
...
API void Matrix::createReflection(const Plane& plane, Matrix* dst)
{
...
API void Matrix::add(float scalar)
{
    add(scalar, this);
}
...
API void Matrix::add(const Matrix& m)
{
    add(*this, m, this);
}
...
API bool Matrix::decompose(Vector3* scale, Quaternion* rotation, Vector3* translation) const
{
    if (translation)
    {
...
API float Matrix::determinant() const
{
...
API void Matrix::getScale(Vector3* scale) const
{
    decompose(scale, NULL, NULL);
}

API bool Matrix::getRotation(Quaternion* rotation) const
{
    return decompose(NULL, rotation, NULL);
}

API void Matrix::getTranslation(Vector3* translation) const
{
...
API bool Matrix::invert()
{
    return invert(this);
}

API bool Matrix::invert(Matrix* dst) const
{
    float a0 = m[0] * m[5] - m[1] * m[4];
    float a1 = m[0] * m[6] - m[2] * m[4];
    float a2 = m[0] * m[7] - m[3] * m[4];
...
API bool Matrix::isIdentity() const
{
    return (memcmp(m, MATRIX_IDENTITY, MATRIX_SIZE) == 0);
}

API void Matrix::multiply(float scalar)
{
    multiply(scalar, this);
}

API void Matrix::multiply(float scalar, Matrix* dst) const
{
...
API void Matrix::multiply(const Matrix& m)
{
...
API void Matrix::rotate(const Quaternion& q)
{
    rotate(q, this);
}

API void Matrix::rotate(const Quaternion& q, Matrix* dst) const
{
    Matrix r;
    createRotation(q, &r);
    multiply(*this, r, dst);
...
API void Matrix::rotate(const Vector3& axis, float angle)
{
    rotate(axis, angle, this);
}

API void Matrix::rotate(const Vector3& axis, float angle, Matrix* dst) const
{
    Matrix r;
...
API void Matrix::rotateX(float angle)
{
    rotateX(angle, this);
}

API void Matrix::rotateX(float angle, Matrix* dst) const
{
    Matrix r;
...
API void Matrix::rotateY(float angle)
{
    rotateY(angle, this);
}

API void Matrix::rotateY(float angle, Matrix* dst) const
{
    Matrix r;
...
API void Matrix::rotateZ(float angle)
{
    rotateZ(angle, this);
}

API void Matrix::rotateZ(float angle, Matrix* dst) const
{
    Matrix r;
...
API void Matrix::scale(float value)
{
    scale(value, this);
}

API void Matrix::scale(float value, Matrix* dst) const
{
    scale(value, value, value, dst);
}

API void Matrix::scale(float xScale, float yScale, float zScale)
{
    scale(xScale, yScale, zScale, this);
}

API void Matrix::scale(float xScale, float yScale, float zScale, Matrix* dst) const
{
    Matrix s;
...
API void Matrix::scale(const Vector3& s)
{
    scale(s.x, s.y, s.z, this);
}

API void Matrix::scale(const Vector3& s, Matrix* dst) const
{
    scale(s.x, s.y, s.z, dst);
}

API void Matrix::set(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
                 float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44)
{
    m[0]  = m11;
    m[1]  = m21;
...
API void Matrix::set(const Matrix& m)
{
    memcpy(this->m, m.m, MATRIX_SIZE);
}

API void Matrix::setIdentity()
{
    memcpy(m, MATRIX_IDENTITY, MATRIX_SIZE);
}

API void Matrix::setZero()
{
    memset(m, 0, MATRIX_SIZE);
}

API void Matrix::subtract(const Matrix& m)
{
...
API void Matrix::transformPoint(const Vector3& point, Vector3* dst) const
{
...
API void Matrix::transformVector(const Vector3& vector, Vector3* dst) const
{
...
API void Matrix::translate(float x, float y, float z)
{
    translate(x, y, z, this);
}

API void Matrix::translate(float x, float y, float z, Matrix* dst) const
{
    Matrix t;
...
API void Matrix::translate(const Vector3& t)
{
    translate(t.x, t.y, t.z, this);
}

API void Matrix::translate(const Vector3& t, Matrix* dst) const
{
    translate(t.x, t.y, t.z, dst);
}

API void Matrix::transpose()
{
    transpose(this);
}
