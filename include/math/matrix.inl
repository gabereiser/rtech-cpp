...
namespace math
{
API inline const Matrix Matrix::operator+(const Matrix& m) const
{
    Matrix result(*this);
    result.add(m);
    return result;
...
API inline Matrix& Matrix::operator+=(const Matrix& m)
{
    add(m);
    return *this;
}
...
API inline const Matrix Matrix::operator-() const
{
    Matrix m(*this);
    m.negate();
    return m;
